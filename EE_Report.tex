...
\caption{Average number of iterations against average \% error}
\end{figure}

Although i prefer this one more, it uses the same right colum, but because the number of iterations changes in future simulations for better comparisons and predictions i used the average number of iterations according to the fractions. 

Now here are all my collected data findings for all other geometries
Cone:

\begin{table}[H]
\centering
\caption{Full data collected for the cone simulation}
\adjustbox{width=\textwidth}{
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|c|}
\hline
\textbf{Iteration} & \textbf{Expected /N} & \textbf{Mesh 1 /N} & \textbf{\% error} & \textbf{Mesh 2 /N} & \textbf{\% error} & \textbf{Mesh 3 /N} & \textbf{\% error} & \textbf{Mesh 4 /N} & \textbf{\% error} & \textbf{Mesh 5 /N} & \textbf{\% error} \\
...
\caption{Average \% error against fractional amount of iterations for the cone}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{image12.png}
\caption{Average \%error against element size of the mesh for the cone}
\end{figure}

Half sphere:
\begin{table}[H]
\centering
\caption{Full data collected for the half sphere simulation}
\adjustbox{width=\textwidth}{
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|c|}
\hline
\textbf{Iteration} & \textbf{Expected /N} & \textbf{Mesh 1 /N} & \textbf{\% error} & \textbf{Mesh 2 /N} & \textbf{\% error} & \textbf{Mesh 3 /N} & \textbf{\% error} & \textbf{Mesh 4 /N} & \textbf{\% error} & \textbf{Mesh 5 /N} & \textbf{\% error} \\
...
\caption{Average \% error against fractional amount of iterations for the half sphere}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{image21.png}
\caption{Average \%error against element size of the mesh for the half sphere}
\end{figure}

Streamline body:
\begin{table}[H]
\centering
\caption{Full data collected for the streamline body simulation}
\adjustbox{width=\textwidth}{
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|c|}
\hline
\textbf{Iteration} & \textbf{Expected /N} & \textbf{Mesh 1 /N} & \textbf{\% error} & \textbf{Mesh 2 /N} & \textbf{\% error} & \textbf{Mesh 3 /N} & \textbf{\% error} & \textbf{Mesh 4 /N} & \textbf{\% error} & \textbf{Mesh 5 /N} & \textbf{\% error} \\
...
\caption{Average \% error against fractional amount of iterations for the streamline body}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{image18.png}
\caption{Average \%error against element size of the mesh for the streamline body}
\end{figure}

Long cylinder:
\begin{table}[H]
\centering
\caption{Full data collected for the long cylinder simulation}
\adjustbox{width=\textwidth}{
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|c|}
\hline
\textbf{Iteration} & \textbf{Expected /N} & \textbf{Mesh 1 /N} & \textbf{\% error} & \textbf{Mesh 2 /N} & \textbf{\% error} & \textbf{Mesh 3 /N} & \textbf{\% error} & \textbf{Mesh 4 /N} & \textbf{\% error} & \textbf{Mesh 5 /N} & \textbf{\% error} \\
